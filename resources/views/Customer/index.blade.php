...
// LoadPercentage
                    ...
                    <div class="bs-example">
                        <div class="bs-center">
                            <!--服务器相关参数-->
                            <table width="100%" cellpadding="3" cellspacing="0" class="table table-bordered table-hover">
    ...
    <?php if($sysInfo['win_n'] != ''){echo $sysInfo['win_n'];}else{echo @php_uname();};?></td>
            ...
            <tr>
                ...
                <td width="36%"><?php $os = explode(" ", php_uname()); echo $os[0];?> &nbsp;内核版本：<?php if('/'==DIRECTORY_SEPARATOR){echo $os[2];}else{echo $os[1];} ?></td>
            ...
            <tr>
                <td>管理员邮箱</td>
                <td>zjwlgr@yeah.net</td>
                <td>探针路径</td>
                <td><?php echo $_SERVER['DOCUMENT_ROOT'].$_SERVER['$PATH_INFO'].$_SERVER['PHP_SELF'];?></td>
            </tr>
        </table>

        <table width="100%" cellpadding="3" cellspacing="0" align="center" class="table table-bordered table-hover">
            <tr>
